...
namespace FinalProject
{
    public partial class WelcomeForm : Form
    {
        ...
        {
            // Set sizes for your NumericUpDown controls
           // Phone.Size = new Size(259, 26);
            UserID.Size = new Size(259, 26);

            // You could also set other initial properties here
            //Phone.Value = 0;
            UserID.Value = 0;
           // Country.SelectedIndex = -1;  // No country selected initially
        }
